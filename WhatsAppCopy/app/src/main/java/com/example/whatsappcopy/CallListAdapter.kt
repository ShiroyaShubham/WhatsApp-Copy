...
class CallListAdapter(var statusList: ArrayList<StatusListModel>) : RecyclerView.Adapter<CallListAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var v:View=LayoutInflater.from(parent.context).inflate(R.layout.call_list_item,parent,false)
